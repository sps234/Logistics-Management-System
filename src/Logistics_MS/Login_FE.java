...
public class Login_FE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLayeredPane2.setBounds(740, 30, 350, 300);
        ...
        jLayeredPane1.setBounds(740, 340, 350, 170);

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Logistics_MS/Pictures/Pic8.png"))); // NOI18N
        jLabel13.setText("bg");
        getContentPane().add(jLabel13);
        jLabel13.setBounds(0, 10, 1220, 580);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(pswrd == null ? cpswrd == null : pswrd.equals(cpswrd))
        {
            ...
            { 
                ...
                Connection Conn=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/cms_java","root","1234");               
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if((uname!=null)&&(pass!=null))
        {
            ...
            {
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection c=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/cms_java","root","1234");
